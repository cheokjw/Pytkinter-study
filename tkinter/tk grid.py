...
#It stays in place even if we resize the window(it stays on the left side of the screen in this case) instead of staying at the middle of the screen as .pack()
